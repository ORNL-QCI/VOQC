...
optimizer/GateCancellation.vo: optimizer/GateCancellation.v optimizer/Equivalences.vo optimizer/OptimizerGates.vo
	coqc $(COQ_OPTS) optimizer/GateCancellation.v

optimizer/HadamardReduction.vo: optimizer/HadamardReduction.v optimizer/Equivalences.vo optimizer/OptimizerGates.vo
...
optimizer/NotPropagation.vo: optimizer/NotPropagation.v optimizer/Equivalences.vo optimizer/OptimizerGates.vo
...
optimizer/OptimizerGates.vo: optimizer/OptimizerGates.v optimizer/Equivalences.vo optimizer/ListRepresentation.vo core/DensitySem.vo
	coqc $(COQ_OPTS) optimizer/OptimizerGates.v

optimizer/PropagateClassical.vo: optimizer/PropagateClassical.v optimizer/OptimizerGates.vo core/DensitySem.vo
	coqc $(COQ_OPTS) optimizer/PropagateClassical.v

optimizer/RemoveZRotationBeforeMeasure.vo: optimizer/RemoveZRotationBeforeMeasure.v optimizer/OptimizerGates.vo core/DensitySem.vo
	coqc $(COQ_OPTS) optimizer/RemoveZRotationBeforeMeasure.v

optimizer/RotationMerging.vo: optimizer/RotationMerging.v optimizer/OptimizerGates.vo core/Utilities.vo
